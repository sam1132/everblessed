  ...
  const onSubmit = async (data) => {
    try {
      ...
      const response = await axios.post(
        "http://localhost:4000/api/ngo/addDonation",
        data, // data is sent as the second argument
        {
          headers: {
            Authorization: `Bearer ${localStorage.getItem("token")}`, // Corrected header name
          },
        }
      );
          ...
          <div className="grid md:grid-cols-2 gap-x-4">
            ...
            <div className="mb-4">
              <label
                ...
                className="block text-xl md:text-2xl font-semibold text-gray-600 mb-1"
              >
                Donation Name
              </label>
              <input
                ...
                className={`w-full px-4 py-2 border ${
                  errors.donationName ? "border-red-500" : "border-gray-300"
            ...
            <div className="mb-4">
              ...
              <input
                ...
                className={`w-full px-4 py-2 border ${
                  errors.quantityNeeded ? "border-red-500" : "border-gray-300"
                } rounded-md focus:outline-none focus:ring-2 focus:ring-green-400`}
